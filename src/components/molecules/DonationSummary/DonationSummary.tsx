...
export function DonationSummary({ amount, dateTo }: DonationSummaryProps) {
  ...
  return (
    <div className="max-xs:rounded-md max-xs:border max-xs:border-stroke max-xs:pt-6">
      ...
      <div className="mt-6 rounded-md bg-[#F4F8FA] px-4 py-6 font-primary text-xs font-normal">
